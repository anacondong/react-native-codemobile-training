...
class YoutubeScreen extends Component {
    ...
    static navigationOptions = ({ navigation }) => {
        return {
            title: navigation.getParam("youtubeItem").title,
            headerStyle: {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        return {
            youtubeID: nextProps.navigation.getParam("youtubeItem").id,
            youtubeTitle: nextProps.navigation.getParam("youtubeItem").title
        };
    }
