...
class BodyTablet extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      ...
      <Text style={{fontWeight: 'bold', fontSize: 18, alignSelf: 'center', marginBottom: 16}}>Codemobiles Header Tablet</Text>
